...
class KategoriTokoController extends Controller
{
    ...
    public function index(){
        return view('backend/master/toko/kategori/index');
    }
    ...
    public function tambah(){
      return view('backend/master/toko/kategori/form');
    }
    ...
    public function simpan(Request $req){
        ...
        if(!$cek_negara){
          ...
          if($enc_id){
            $negara = KategoriToko::find($dec_id);
    ...
    public function ubah($enc_id){
        $dec_id = $this->safe_decode(Crypt::decryptString($enc_id));
        if ($dec_id) {
          $toko = KategoriToko::find($dec_id);
          return view('backend/master/toko/kategori/form',compact('enc_id', 'toko'));
        } else {
