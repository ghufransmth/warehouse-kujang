...
class ReportBOExports implements FromView, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        foreach ($data as $key => $value) {
            ...
            $value->harga             = round($value->price - ($value->price * ($value->discount / 100)));
            // $value->ttl_harga         = number_format($value->ttl_price, 0, ',', '.');
            $value->ttl_harga         = $value->ttl_price;
        ...
        return view('backend/report/back_order/index_bo_excel', [
            'data' => $data,
