...
class AmplopExports implements FromView,ShouldAutoSize{
    ...
    public function view(): View
    {
        ...
        $invoice->colly = $invoicedetailcolly->colly_to;
        ...
        return view('backend/invoice/amplop/excel', [
            'invoice' => $invoice,
            'invoicedetail' => $invoicedetailcolly,
            'tanggal' => $tanggal 
        ]);
    }
}