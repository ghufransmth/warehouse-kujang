...
@section('title', 'PRINT LAPORAN PURCHASE ORDER')
@section('content')
<style>
.swal2-container{
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>PRINT LAPORAN PURCHASE ORDER</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{route('manage.beranda')}}">Beranda</a>
            </li>
            <li class="breadcrumb-item active">
                <a>Laporan Purchase Order</a>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
       ...
       $(document).ready(function(){
        ...
        $('#Print').on('click', function() {
            if($('#perusahaan').val()==''){
                ...
                window.open('{{route('reportpo.print',[null,null])}}/'+$('#perusahaan').val()+'/'+$('#filter_tgl').val(), '_blank');
            }
        ...
        $('#ExportExcel').on('click', function() {
            if($('#perusahaan').val()==''){
                ...
                window.open('{{route('reportpo.excel',[null,null])}}/'+$('#perusahaan').val()+'/'+$('#filter_tgl').val(), '_blank');
            }
        });
        $('#ExportPdf').on('click', function() {
            if($('#perusahaan').val()==''){
                ...
                window.open('{{route('reportpo.pdf',[null,null])}}/'+$('#perusahaan').val()+'/'+$('#filter_tgl').val(), '_blank');
