                    ...
                    <form id="submitData" name="submitData" class="text-right">
                        <div class="pr-4">
                            <div class="d-flex flex-row-reverse row">
                                <div class="col-xs-3">
                                    <a href="{{ route('reportbarangkeluar.pdf', $enc_id) }}" class="btn btn-danger" id="ExportPdf"><span
                                            class="fa fa-file-pdf-o"></span>
                                        Export PDF</a>&nbsp;
                                </div>
                                <div class="col-xs-3">
                                    <a href="{{ route('reportbarangkeluar.excel', $enc_id) }}" class="btn btn-primary" id="ExportExcel"><span
                                            class="fa fa-file-excel-o"></span> Export Excel </a>&nbsp;
                                </div>
                                <div class="col-xs-3">
                                    <a href="{{ route('reportbarangkeluar.print', $enc_id) }}" class="btn btn-secondary" id="Print"><span
