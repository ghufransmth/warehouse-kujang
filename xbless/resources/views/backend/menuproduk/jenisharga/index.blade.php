...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-2">
        ...
        @can('jenisharga.tambah')
          <a href="{{ route('jenisharga.tambah')}}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Tambah Data"><span class="fa fa-pencil-square-o"></span>&nbsp; Tambah</a>
        @endcan
    </div>
</div>
...
<script type="text/javascript">
    var table,tabledata,table_index;
      ...
      function deletejenisharga(e,enc_id){
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'delete',
                    url: '{{route("jenisharga.delete",[null])}}/' + enc_id,
