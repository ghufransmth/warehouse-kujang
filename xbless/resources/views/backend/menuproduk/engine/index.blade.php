...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-2">
        ...
        @can('engine.tambah')
          <a href="{{ route('engine.tambah')}}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Tambah Data"><span class="fa fa-pencil-square-o"></span>&nbsp; Tambah</a>
        @endcan
    </div>
</div>
        ...
        @else
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        type: 'delete',
                        url: '{{route("engine.hapus",[null])}}/' + enc_id,
