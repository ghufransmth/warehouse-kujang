         ...
         function deleteData(e,enc_id){
           ...
           if (result.value) {
             $.ajaxSetup({
              ...
              $.ajax({
               type: 'DELETE',
               url: '{{route("expedisi.hapus",[null])}}/' + enc_id,
