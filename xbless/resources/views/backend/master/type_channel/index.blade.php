...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Master Type Channel</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{route('manage.beranda')}}">Beranda</a>
            </li>
            <li class="breadcrumb-item active">
                <a>Master Type Channel</a>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        ...
        <a href="{{ route('type_channel.tambah')}}" class="btn btn-success" data-toggle="tooltip" data-placement="top"
            ...
            <div class="ibox">
                <div class="ibox-content">
                    ...
                    <div class="table-responsive">
                        <table id="table1" class="table table p-0 table-hover table-striped" style="overflow-x: auto;">
                            <thead>
...
<script type="text/javascript">
    var table,tabledata,table_index;
       $(document).ready(function(){
           ...
           "stateSave"  : true,
           "ajax":{
                    "url": "{{ route("type_channel.getdata") }}",
                    "dataType": "json",
                    "type": "POST",
                    data: function ( d ) {
                      d._token= "{{csrf_token()}}";
