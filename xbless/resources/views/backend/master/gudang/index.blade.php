...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-2">
        ...
        @can('gudang.tambah')
            <a href="{{ route('gudang.tambah')}}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Tambah Data"><span class="fa fa-pencil-square-o"></span>&nbsp; Tambah</a>
        @endcan
...
<script type="text/javascript">
    ...
    function deleteGudang(e,enc_id){
        @cannot('gudang.delete')
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'delete',
                    url: '{{route("gudang.delete",[null])}}/' + enc_id,
