...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Master Jenis Bayar</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{route('manage.beranda')}}">Beranda</a>
            </li>
            <li class="breadcrumb-item active">
                <a>Master Jenis Bayar</a>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        ...
        <a href="{{ route('payment.tambah')}}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Tambah Data"><span class="fa fa-pencil-square-o"></span>&nbsp; Tambah</a>
    </div>
</div>
      ...
      function deleteNegara(e,enc_id){
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'delete',
                    url: '{{route("payment.delete",[null])}}/' + enc_id,
