...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-2">
        <br/>
        <a class="btn btn-white btn-sm" href="{{route('sales.index')}}">Kembali</a>
    </div>
</div>
                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form id="submitData">
                            ...
                            <div class="form-group row"><label class="col-sm-2 col-xs-6 col-form-label">Kode Sales </label>
                            ...
                            <div class="form-group row"><label class="col-sm-2 col-form-label">Username </label>
                                <div class="col-sm-10 error-text">
                                    <p class="col-form-label"> {{$sales->username}}</p>
                                </div>
                            </div>

                            <div class="form-group row"><label class="col-sm-2 col-form-label">Jenis Kelamin</label>
                                <div class="col-sm-10 error-text">
                                    <p class="col-form-label"> {{$sales->jk=='L'?'Laki-laki':'Perempuan'}}</p>
                            ...
                            <div class="form-group row"><label class="col-sm-2 col-form-label">Alamat</label>
                                <div class="col-sm-10 error-text">
                                    <p class="col-form-label"> {{$sales->address}}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group row"><label class="col-sm-2 col-form-label">No Rekening</label>
                                <div class="col-sm-10 error-text">
                                    <p class="col-form-label"> {{$sales->no_rek}}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group row"><label class="col-sm-2 col-form-label">Nama Bank</label>
                                <div class="col-sm-10 error-text">
                                    <p class="col-form-label"> {{$sales->bank_name}}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group row"><label class="col-sm-2 col-form-label">Pemilik Rekening </label>
                                <div class="col-sm-10 error-text">
                                    <p class="col-form-label"> {{$sales->holder_name}}</p>
                                </div>
                            </div>
