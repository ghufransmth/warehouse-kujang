...
@section('title', 'Manajemen Jenis Toko')

@section('content')
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>{{isset($toko) ? 'Edit' : 'Tambah'}} Jenis Toko</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{route('manage.beranda')}}">Beranda</a>
            </li>
            <li class="breadcrumb-item">
                <a href="{{route('toko.jenis.index')}}">Master Jenis Toko</a>
            </li>
    ...
    <div class="col-lg-2">
        <br/>
        <a class="btn btn-white btn-sm" href="{{route('toko.jenis.index')}}">Kembali</a>
    </div>
</div>
                        ...
                        <form id="submitData">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <a class="btn btn-white btn-sm" href="{{route('toko.jenis.index')}}">Batal</a>
...
<script>
    $(document).ready(function () {
        $('#submitData').validate({
            ...
            messages: {
                name: {
                    required: "Jenis Toko tidak boleh kosong"
                },
            },
            errorElement: 'span',
            ...
            $.ajax({
                ...
                success: function(data){
                    if (data.success) {
                        ...
                        window.location.replace('{{route("toko.jenis.index")}}');
                    } else {
