...
@section('title', 'Expedisi Via')

@section('content')
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Master Expedisi Via</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{route('manage.beranda')}}">Beranda</a>
            </li>
            <li class="breadcrumb-item active">
                <a>Master Expedisi Via</a>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
        ...
        @can('expedisivia.tambah')
        <a href="{{ route('expedisivia.tambah')}}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Tambah Data"><span class="fa fa-pencil-square-o"></span>&nbsp; Tambah</a>
        @endcan
    </div>
</div>
         ...
         function deleteData(e,enc_id){
           ...
           if (result.value) {
             $.ajaxSetup({
              ...
              $.ajax({
               type: 'DELETE',
               url: '{{route("expedisivia.hapus",[null])}}/' + enc_id,
