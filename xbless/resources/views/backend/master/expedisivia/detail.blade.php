...
@section('title', 'Detail Expedisi Via ')

@section('content')
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Detail Expedisi Via</h2>
        <ol class="breadcrumb">
    ...
    <div class="col-lg-2">
        <br/>
        <a class="btn btn-white btn-sm" href="{{route('expedisivia.index')}}">Kembali</a>
    </div>
</div>
