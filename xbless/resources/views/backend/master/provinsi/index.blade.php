...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-2">
        ...
        @can('provinsi.tambah')
        <a href="{{ route('provinsi.tambah')}}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Tambah Data"><span class="fa fa-pencil-square-o"></span>&nbsp; Tambah</a>
        @endcan
    </div>
</div>
         ...
         function deleteData(e,enc_id){
           ...
           if (result.value) {
             $.ajaxSetup({
              ...
              $.ajax({
               type: 'DELETE',
               url: '{{route("provinsi.hapus",[null])}}/' + enc_id,
