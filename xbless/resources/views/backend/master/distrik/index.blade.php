...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-2">
        ...
        <a href="{{ route('distrik.tambah')}}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Tambah Data"><span class="fa fa-pencil-square-o"></span>&nbsp; Tambah</a>
    </div>
</div>
      ...
      function deleteNegara(e,enc_id){
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: 'delete',
                    url: '{{route("distrik.delete",[null])}}/' + enc_id,
