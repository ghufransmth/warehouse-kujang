				...
				<tbody>
					...
					@foreach($detail_tanda_terima as $key => $value)
						...
						<tr>
							...
							<td align='right' style='font-size:13px;'>Rp. {{ number_format($value->nilai_pengiriman, 0, '', '.').',00' }}</td>
							<td align='right' style='font-size:13px;'>Rp. {{ number_format($value->nilai_pengiriman, 0, '', '.').',00' }}</td>
					...
					<tr height="25px">
						...
						<td align="right" style="height: 15px;"><p style="font-size:14px;"><b>Rp. {{ number_format($grandTotal, 0, '', '.').',00' }}</b></p></td>
					</tr>
				</tbody>
			</table>
			<table border="0" width="100%">
