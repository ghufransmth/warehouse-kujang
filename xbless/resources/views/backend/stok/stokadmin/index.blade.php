...
@section('title', 'Informasi Stok Admin')
@section('content')
<style>
.swal2-container{
...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Informasi Stok Admin</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{route('manage.beranda')}}">Beranda</a>
            </li>
            <li class="breadcrumb-item active">
                <a>Informasi Stok Admin Produk</a>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
...
<script type="text/javascript">
    var table,tabledata,table_index,tableproduct;
       $(document).ready(function(){
           ...
           "dom": '<"html5">lftip',
           "ajax":{
                    "url": "{{ route("stokadmin.getdata") }}",
                    "dataType": "json",
                    "type": "POST",
                    data: function ( d ) {
                      d._token= "{{csrf_token()}}";
                      d.filter_perusahaan_admin       = $('#perusahaan').val();
           ...
           "columns": [
               ...
               { "data": "nama_kategori"},
               { "data": "nama_satuan"},
               { "data": "adj","className" : "text-center",},
               { "data": "opname","className" : "text-center",},
               { "data": "masuk","className" : "text-center",},
               { "data": "keluar","className" : "text-center",},
